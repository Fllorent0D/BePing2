...
export { WeeklyNumericPointsV3 } from './models/weekly-numeric-points-v-3';
export { NumericRankingPerWeekOpponentsV3 } from './models/numeric-ranking-per-week-opponents-v-3';
export { NumericRankingDetailsV3 } from './models/numeric-ranking-details-v-3';
export { WeeklyNumericRankingV3 } from './models/weekly-numeric-ranking-v-3';
