describe('HomeScreen', () => {
    describe('Select main player', () => {
        ...
        it('should select a main player', () => {
            ...
            cy.get('beping-choose-main-member-club ion-item').eq(0).click({force: true}).wait(1_500);
            cy.get('#search-club > div > input').wait(1_000).eq(0).type('N051', {force: true}).wait(500);
